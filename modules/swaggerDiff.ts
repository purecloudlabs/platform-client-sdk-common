...
export default class SwaggerDiff {
	...
	public getAndDiff(oldSwaggerPath, newSwaggerPath, previewSwaggerPath ,saveOldSwaggerPath, saveNewSwaggerPath) {
	...
	public diff(oldSwagger, newSwagger) {
...
//var this = (module.exports = new SwaggerDiff());
...
function combineSwagger(publicSwagger:{ [key: string]: any }, preview:{ [key: string]: any }){

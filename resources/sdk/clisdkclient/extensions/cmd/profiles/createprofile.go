...
func constructConfig(profileName string, environment string, redirectUri string, clientID string, clientSecret string) config.Configuration {
	...
	c.CodeAuthorizationCodeFunc = func() string {
		return ""
	}
...
func requestUserInput() config.Configuration {
	...
	return constructConfig(name, environment, redirectURI, clientID, clientSecret)
}

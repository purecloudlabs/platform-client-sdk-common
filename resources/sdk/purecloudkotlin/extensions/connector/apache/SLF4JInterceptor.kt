 ...
 */
class SLF4JInterceptor @JvmOverloads constructor(@field:Volatile private var detailLevel: DetailLevel? = DetailLevel.MINIMAL) : HttpRequestInterceptor, HttpResponseInterceptor {

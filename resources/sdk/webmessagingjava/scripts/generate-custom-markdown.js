const mdjd = require('mdjavadoc-api')
const path = require("path")
const fs = require("fs")

const filePath = process.argv[2]
const fileName = process.argv[3]
const saveMarkdownFile = process.argv[4]
...
for (const methodDeclaration of parsedFile) {
    ...
    fileOutput += `| [**${methodDeclaration.name}**](${fileName}.html#${methodDeclaration.name}${numberOfDeclarations}) | ${description} |\n`
}
...
if (saveMarkdownFile) {
    const savePath = path.join(saveMarkdownFile, fileName) + ".md"
